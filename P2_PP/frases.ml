(*x - y;;*)
(*Mostrará un error léxico, no están definida ni la x ni la y, Error: Unbound value x*)
...
(*g 3.0;;*)
(*devuelve un error de tipos, Error: This expression has type float but an expression was expected of type int*)
...
(*istrue 0;;*)
(*saltara un error de tipos porque 0 no es de tipo bool, Error: This expression has type int but an expression was expected of type bool*)
